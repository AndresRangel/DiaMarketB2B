...
mixin _$CompanyDto {
 ...
 String get id; String get code; String get name;@JsonKey(name: 'logo_url') String? get logoUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CompanyDto&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl));
}
...
@override
String toString() {
  return 'CompanyDto(id: $id, code: $code, name: $name, logoUrl: $logoUrl)';
}
...
@useResult
$Res call({
 String id, String code, String name,@JsonKey(name: 'logo_url') String? logoUrl
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String code,  String name, @JsonKey(name: 'logo_url')  String? logoUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CompanyDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String code,  String name, @JsonKey(name: 'logo_url')  String? logoUrl)  $default,) {final _that = this;
switch (_that) {
case _CompanyDto():
return $default(_that.id,_that.code,_that.name,_that.logoUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String code,  String name, @JsonKey(name: 'logo_url')  String? logoUrl)?  $default,) {final _that = this;
switch (_that) {
case _CompanyDto() when $default != null:
return $default(_that.id,_that.code,_that.name,_that.logoUrl);case _:
  return null;
...
class _CompanyDto implements CompanyDto {
  const _CompanyDto({required this.id, required this.code, required this.name, @JsonKey(name: 'logo_url') this.logoUrl});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CompanyDto&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl));
}

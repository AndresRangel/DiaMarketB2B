...
mixin _$AuthSessionEntity {
 ...
 UserEntity get user;/// Access token JWT — va en el header Authorization de cada request.
 String get sessionToken;/// Refresh token — se usa para renovar el access token cuando expira.

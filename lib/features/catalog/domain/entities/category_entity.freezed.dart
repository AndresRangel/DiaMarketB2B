...
mixin _$CategoryEntity {
 ...
 String get id; String get name;/// null = categoría raíz. Si tiene valor = subcategoría hija.
 String? get parentId;/// Posición de orden para el menú. Puede ser null si no está definido.
 int? get sortOrder;/// URL de imagen de la categoría desde el CDN. Null si no viene del backend.
 String? get imageUrl; bool get isActive;
...
@override
String toString() {
  return 'CategoryEntity(id: $id, name: $name, parentId: $parentId, sortOrder: $sortOrder, imageUrl: $imageUrl, isActive: $isActive)';
}
...
@useResult
$Res call({
 String id, String name, String? parentId, int? sortOrder, String? imageUrl, bool isActive
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? parentId,  int? sortOrder,  String? imageUrl,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? parentId,  int? sortOrder,  String? imageUrl,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
return $default(_that.id,_that.name,_that.parentId,_that.sortOrder,_that.imageUrl,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? parentId,  int? sortOrder,  String? imageUrl,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.parentId,_that.sortOrder,_that.imageUrl,_that.isActive);case _:
  return null;
...
class _CategoryEntity extends CategoryEntity {
  const _CategoryEntity({required this.id, required this.name, this.parentId, this.sortOrder, this.imageUrl, this.isActive = true}): super._();
